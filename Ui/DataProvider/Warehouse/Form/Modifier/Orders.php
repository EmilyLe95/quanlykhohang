 ...
 */
class Orders extends \Magestore\InventorySuccess\Ui\DataProvider\Form\Modifier\Dynamic
{
    /**
    ...
    protected $_groupLabel = 'Orders';
    protected $_sortOrder = 20;
    protected $_groupContainer = 'orders';
    ...
    protected function getStockMovements(){
        $listingTarget = 'os_warehouse_order_listing';
        return [
            'arguments' => [
                'data' => [
                    'config' => [
