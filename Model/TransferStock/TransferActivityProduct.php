...
class TransferActivityProduct extends AbstractModel implements
    \Magestore\InventorySuccess\Api\Data\TransferStock\TransferActivityProductInterface,
    \Magestore\InventorySuccess\Api\StockActivity\StockActivityProductInterface
{
    ...
    {
        parent::_construct();
        $this->_init('Magestore\InventorySuccess\Model\ResourceModel\TransferStock\TransferActivityProduct');
    }
