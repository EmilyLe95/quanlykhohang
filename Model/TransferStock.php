...
class TransferStock extends AbstractModel implements
    \Magestore\InventorySuccess\Api\Data\TransferStock\TransferStockInterface,
    \Magestore\InventorySuccess\Api\StockActivity\StockActivityInterface
{
    ...
    {
        parent::_construct();
        $this->_init('Magestore\InventorySuccess\Model\ResourceModel\TransferStock');
    }
