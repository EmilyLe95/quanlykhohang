...
namespace Magestore\InventorySuccess\Block\Adminhtml\LowStockNotification\Rule\Edit\Tab;
...
class Conditions extends Generic implements TabInterface
{
    ...
    {
        $model = $this->_coreRegistry->registry('current_lowstock_notification_rule');
     ...
     */
    protected function addTabToForm($model, $fieldsetId = 'conditions_fieldset', $formName = 'os_lowstock_notification_rule_form')
    {
        /** @var \Magento\Framework\Data\Form $form */
