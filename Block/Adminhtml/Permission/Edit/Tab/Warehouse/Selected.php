...
namespace Magestore\InventorySuccess\Block\Adminhtml\Permission\Edit\Tab\Warehouse;

use Magento\Backend\Block\Widget\Grid\Column;

class Selected extends \Magento\Backend\Block\Widget\Grid\Extended
{
    /**
     * Core registry
     *
    ...
    protected function _construct()
    {
        ...
        $this->setTitle(__('User Role Information'));
            ...
            [
                ...
                'actions' => [
                    [
                        'caption' => __('Remove'),
                        'url' => [
                            'base' => 'inventorysuccess/staff_permission/removeWarehouse',
