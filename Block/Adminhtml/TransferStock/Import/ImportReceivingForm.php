...
class ImportReceivingForm extends \Magento\Backend\Block\Template
{
    protected $_template = 'Magestore_InventorySuccess::transferstock/import_receive_form.phtml';
