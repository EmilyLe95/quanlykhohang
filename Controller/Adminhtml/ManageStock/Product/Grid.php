 ...
 */
class Grid extends \Magestore\InventorySuccess\Controller\Adminhtml\Warehouse\AbstractWarehouse
{
    protected $_stockGrid = 'Magestore\InventorySuccess\Block\Adminhtml\ManageStock\Stock\Fieldset\Product\Grid';
    protected $_stockGridName = 'warehouse.stock.grid';
