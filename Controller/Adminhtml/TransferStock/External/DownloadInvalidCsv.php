...
class DownloadInvalidCsv extends \Magestore\InventorySuccess\Controller\Adminhtml\TransferStock\AbstractRequest
{
    ...
    public function execute()
    {
        ...
        if ($type == \Magestore\InventorySuccess\Model\Source\Adminhtml\ImportType::TYPE_TRANSFER_STOCK_TO_TRANSFER_EXTERNAL_FROM) {
        ...
        return $this->fileFactory->create(
            'import_product_to_transfer_external_invalid.csv',
