...
class SaveImportReceiving extends \Magestore\InventorySuccess\Controller\Adminhtml\TransferStock\Request\Save
{
    public function execute()
    {
        ...
        if ($this->getRequest()->isPost()) {
            try {
                ...
                $data = $importHandler->importFromCsvFile($this->getRequest()->getFiles('import_receiving_product'), \Magestore\InventorySuccess\Model\Source\Adminhtml\ImportType::TYPE_TRANSFER_STOCK_TO_TRANSFER_RECEIVING);
