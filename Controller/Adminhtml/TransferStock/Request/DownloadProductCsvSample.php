...
class DownloadProductCsvSample extends \Magestore\InventorySuccess\Controller\Adminhtml\TransferStock\AbstractRequest
{
    ...
    public function execute()
    {
        ...
        return $this->fileFactory->create(
            'import_product_to_request_stock.csv',
            array(
                'type' => 'filename',
                'value' => $filename,
